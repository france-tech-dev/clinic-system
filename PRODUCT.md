...
- Superfícies: Dashboard (liderança: KPIs/gráficos), Agenda (turno clínico do dia), Pacientes, Anamnese, Avaliações, Caixa, Profissionais, Busca, Configurações, Organização, Planos; Portal do responsável em evolução.
