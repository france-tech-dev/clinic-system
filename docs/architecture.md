...
- Dialogs longos: shell scrollável (`dialogScrollableClassName` + header/body/footer em `@/components/ui/dialog`; no mobile ancora em baixo como sheet) — não `overflow-y-auto` no `DialogContent` inteiro
